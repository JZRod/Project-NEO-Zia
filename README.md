...
### Configuration
This PCB is designed to accept power from an external 12 volt input. It is also able to recive power from a 5 volt PWM cable. By defult the board is configured to recive power from the 12 volt external power input.  
...
>- The PWM output connecter outputs whetever voltage it is provided through the PWM input  
>- The PWM output **does not touch the voltage regulator on the board at all**  
>- The pinout of these connecters is also labeled on the board  
### Mounting
...
## Manufacturing
If you want to make this board you can either use the pre-made gerber files or customize them using the KiCad project files. All these files are avalible in the revision folders.
### Pre-Made Gerbers
...
> Some PCB manufacuring services will accept the bare KiCad PCB file.   
...
**Designed by Josh Rodriguez for FIRST Robotics Team 1164 Project NEO**
